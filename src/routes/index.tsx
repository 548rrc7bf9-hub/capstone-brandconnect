  ...
  head: () => ({
    meta: [
      { title: "Capstone HS Inc. — OEM Bag Manufacturing & Brand Licensing" },
      {
        name: "description",
        content:
          "Since 1987, Capstone HS Inc. has produced sports, outdoor and casual bags through OEM/ODM manufacturing, and holds exclusive licensing agentship for Santa Barbara Polo & Racquet Club in Korea and Vietnam.",
      },
      {
        property: "og:title",
      ...
      <section className="relative overflow-hidden bg-navy-deep text-primary-foreground">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-28 lg:py-36">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-relaxed text-primary-foreground/70">
            ...
            and casual bags through OEM manufacturing for recognized international labels.
          </p>
        ...
        <div className="mx-auto grid max-w-6xl gap-px border border-border bg-border md:grid-cols-2">
          <div className="bg-background p-12">
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              We build to your design and specification, working with partner factories
              under our direction from development through export.
            </p>
            <Link
              to="/manufacturing"
